...
class StarButton extends StatefulWidget{
  ...
  @override
  State<StarButton> createState() => _StarButtonState(); // Todo StatefulWidget precisa de uma função em que vai ficar re-instanciando o widget toda vez que houver uma uma mudança por isso o tipo de retorno State.
}
